...
function Home() {
  ...
  useEffect(() => {
      init(profession.current, { showCursor: false, backDelay: 1000,backSpeed: 60, loop: false , strings: ["International Cheff and Entrepreneur"] });
    }
  )
        ...
        <div className="home__container container grid">
          <div className="home__content grid">
            ...
            <div className="home__data">
              <h1 className="home__title">Hi, I'm Sandra</h1>
              <h3 className="home__subtitle" ref={profession}>{" "}</h3>
              <p className="home__description">
                Culinary career with over 15
                years of experience.
              </p>
